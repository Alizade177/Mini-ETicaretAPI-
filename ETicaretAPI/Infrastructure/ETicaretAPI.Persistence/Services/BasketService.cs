...
namespace ETicaretAPI.Persistence.Services
{
    public class BasketService : IBasketService
    {
        ...
        public BasketService(IHttpContextAccessor httpContextAccessor, UserManager<AppUser> userManager, IOrderReadRepository orderReadRepository, IBasketWriteRepository basketWriteRepository = null, IBasketItemWriteRepository basketItemWriteRepository = null, IBasketItemReadRepository basketItemReadRepository = null, IBasketReadRepository basketReadRepository = null)
        {
        ...
        private async Task<Basket?> ContextUser()
        {
            ...
            if (!string.IsNullOrEmpty(username))
            {
               AppUser? user = await _userManager.Users
                ...
                await _basketWriteRepository.SaveAsnyc();
                return targetBasket;
            }
        ...
        public async Task AddItemToBasketAsync(VM_Create_BasketItem basketItem)
        {
            ...
            if(basket != null)
            {
                ...
                await _basketItemWriteRepository.SaveAsnyc();
            }
        }
