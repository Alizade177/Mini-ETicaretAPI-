...
namespace ETicaretAPI.Persistence.Services
{
    public class AuthorizationEndpointService : IAuthorizationEndpointService
    {
        ...
        public AuthorizationEndpointService(IApplicationService applicationService, IEndpointReadRepository endpointReadRepository, IEndpointWriteRepository endpointWriteRepository, IMenuReadRepository menuReadRepository = null, IMenuWriteRepository menuWriteRepository = null, RoleManager<AppRole> roleManager = null)
        {
        ...
        public async Task AssignRoleEndpointAsync(string[] roles,string menu ,string code,Type type)
        {
            ...
            if (_menu == null)
            {
                ...
                await _menuWriteRepository.SaveAsnyc();
            }
            ...
            if (endpoint == null) 
            {
              var action = _applicationService.GetAuthorizeDefinitionEndpoints(type)
                ...
                await _endpointWriteRepository.SaveAsnyc();
            }
