...
builder.Services.AddHttpContextAccessor();//clientdan gelen reqeust neticesinde olusturulan HttpContext nesnesine katmanlardaki class'lar uzerinden(business logic) erisebilmemizi saglayan bri servistir.
