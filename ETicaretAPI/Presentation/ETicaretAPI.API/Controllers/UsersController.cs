...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            CreateUserCommandResponse response = await _mediator.Send(createUserCommnadRequest);
            return Ok(response);
        }
        ...
        [AuthorizeDefinition(ActionType = ActionType.Reading, Definition = "Assign Role To User", 
         Menu = "Users")]
