...
namespace ETicaretAPI.API.Controllers
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = ("Admnin"))]
    public class RolesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetRoles([FromRoute] GetRoleByIdQueryRequest getRoleByIdQueryResponse )
        {
            GetRoleByIdQueryResponse response = await _mediator.Send(getRoleByIdQueryResponse);
            return Ok(response);
        }
