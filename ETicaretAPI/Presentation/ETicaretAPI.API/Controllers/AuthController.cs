...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> GoogleLogin(GoogleLoginCommnadRequest googleLoginCommnadRequest)
        {
            GoogleLoginCommnadResponse response = await _mediator.Send(googleLoginCommnadRequest);
            return Ok(response);
        }


        [HttpPost("facebook-login")]
        public async Task<IActionResult> FacebookLogin(FacebookLoginCommandRequest facebookLoginCommnadRequest)
        {
            FacebookLoginCommandResponse response = await _mediator.Send(facebookLoginCommnadRequest);
            return Ok(response);
        }
